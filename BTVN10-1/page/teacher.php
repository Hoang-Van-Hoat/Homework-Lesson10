...
<body>
    ...
    <div class="row">
        ...
        <div class="main-page col-sm-10">
            <h3 class="title">Đây là trang danh sách giáo viên</h3>
        <div class="block">
                <?php
                        ...
                        <tr>
                            <?php
                                foreach($teacherList as $teacher) {
                                    ...
                                    $major = $teacher['major'] ?? "N/A";
                                    $contract = $teacher['contract'] ?? "N/A";
                ...
                <?php
                    ...
                    echo "Danh sách giáo viên trống";
                }   
                ?>
            </div>
        </div>
